...
public class TController extends login implements Initializable {
    @FXML
    ...
    private int row;
    private ArrayList<ArrayList<Integer>> gridPaneCellsList = new ArrayList<ArrayList<Integer>>();
...
public void handleMachineButton(ActionEvent event) {
    ...
    @FXML
    public void handleTommorow(ActionEvent event) throws IOException {
        writeArrayToFile("Today.txt");
        switchScene("TimeTableAdmin2.fxml"); //set the scene to the home page
    }
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        tommorow.setOnAction(event -> {
            try {
                handleTommorow(event);
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
